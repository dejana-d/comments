...
function addComment(ev) {
    ...
    if(hasClass(ev.target.parentElement, 'container')) {
        ...
        // styling for posted comments. not sure why it's not in css file
        textBox.style.backgroundColor = "#c0aeed"; 
        textBox.style.border = "2px solid #202124";
        wrapDiv.append(textBox, replyButton);
        // original with like and reply and delete options 
